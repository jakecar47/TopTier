...
function Menu({ items }: MenuProps) {
  return (
    <Card>
      <nav className="mx-auto max-w-[320px] w-full px-2 pt-2 pb-[712px] overflow-hidden">
          <header className="overflow-hidden px-4 pt-2 pb-1 w-full text-base font-semibold leading-snug text-white flex justify-center">
              <h2>Games</h2>
          </header>
